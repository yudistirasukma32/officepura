...
function jZebra() {
  $("#appletContainer").html(
    '<applet name="jzebra" code="jzebra.PrintApplet.class" archive="/assets/jzebra.jar" width="1" height="1"><param name="cache_option" value="plugin"><param name="cache_archive" value="/assets/jzebra.jar"><param name="cache_version" value="1.4.8.0"></applet>'
  );
}
...
function zebraprint(name) {
  if (applet != null) {
    if (name == "invoice") {
      ...
      applet.append("-----------------------------------\n");
      applet.append(
        "UM Supir    Rp. " + $("#invoice_driver_allowance").val() + ",00\n"
      );
      applet.append(
        "UM Kernet   Rp. " + $("#invoice_helper_allowance").val() + ",00\n"
      );
      applet.append(
        "Lain-lain   Rp. " + $("#invoice_misc_allowance").val() + ",00\n"
      );
      applet.append(
        "Solar       Rp. " + $("#invoice_gas_allowance").val() + ",00\n"
      );
      applet.append(
        "ASDP        Rp. " + $("#invoice_ferry_fee").val() + ",00\n"
      );
      applet.append("Tol         Rp. " + $("#invoice_tol_fee").val() + ",00\n");
      applet.append(
        "Premi       Rp. " + $("#invoice_premi_allowance").val() + ",00\n"
      );
      applet.append("-----------------------------------\n");
      applet.append(
        "Total       Rp. " + $("#invoice_total").val() + ",00" + "\n"
      );
      applet.append("-----------------------------------\n");
      ...
      $("#tableorder tr").each(function () {
        ...
        if (parseInt(id) > 0) {
          ...
          applet.append(
            align_left(
              $("#productname_" + id).html() + " " + $("#bon_" + id).val(),
              41
            )
          );
          ...
          applet.append(
            align_left(print_whitespace(4) + $("#supplier_" + id).val(), 41) +
              "\n"
          );
          index++;
        }
      ...
      applet.append(
        print_whitespace(55) +
          align_right("TOTAL", 10) +
          align_right($("#strTotal").html(), 14) +
          "\n"
      );
      applet.append(
        "-------------------------------------------------------------------------------\n"
      ...
      applet.append(
        align_left("Non HLN", 18) +
          ": " +
          align_right($("#lblNonHolidays").html(), 12) +
          " x " +
          align_right($("#lblNonHolidaysFare").html(), 12) +
          " = " +
          align_right($("#lblNonHolidaysPayment").html(), 12) +
          "\n"
      );
      applet.append(
        align_left("HLN", 18) +
          ": " +
          align_right($("#lblHolidays").html(), 12) +
          " x " +
          align_right($("#lblHolidaysFare").html(), 12) +
          " = " +
          align_right($("#lblHolidaysPayment").html(), 12) +
          "\n"
      );
      applet.append(
        align_left("Ambil Tabungan", 18) +
          ": " +
          print_whitespace(27) +
          " = " +
          align_right($("#lblSavingReduction").html(), 12) +
          "\n"
      );
      applet.append(
        align_left("Premi Hadir", 18) +
          ": " +
          print_whitespace(27) +
          " = " +
          align_right($("#lblBonus").html(), 12) +
          "\n"
      );
      applet.append(
        align_left("TOTAL", 50) +
          align_right($("#lblTotalPayment").html(), 12) +
          "\n\n"
      );
      applet.append(
        "Revisi Tabungan (" +
          $("#lblMasterSaving").html() +
          " - " +
          $("#lblSavingReduction2").html() +
          " = " +
          $("#lblSavingRed").html() +
          ")" +
          "\n\n"
      ...
      applet.append(
        align_left("Klaim Susut", 18) +
          ": " +
          align_right($("#lblMasterWeightLoss").html(), 12) +
          print_whitespace(3) +
          align_right($("#lblPayrollWeightLoss").html(), 12) +
          print_whitespace(3) +
          align_right($("#lblTotalWeightLoss").html(), 12) +
          "\n"
      );
      applet.append(
        align_left("Klaim Kecelakaan", 18) +
          ": " +
          align_right($("#lblMasterAccident").html(), 12) +
          print_whitespace(3) +
          align_right($("#lblPayrollAccident").html(), 12) +
          print_whitespace(3) +
          align_right($("#lblTotalAccident").html(), 12) +
          "\n"
      );
      applet.append(
        align_left("Klaim Onderdil", 18) +
          ": " +
          align_right($("#lblMasterSparepart").html(), 12) +
          print_whitespace(3) +
          align_right($("#lblPayrollSparepart").html(), 12) +
          print_whitespace(3) +
          align_right($("#lblTotalSparepart").html(), 12) +
          "\n"
      );
      applet.append(
        align_left("Pinjaman", 18) +
          ": " +
          align_right($("#lblMasterBon").html(), 12) +
          print_whitespace(3) +
          align_right($("#lblPayrollBon").html(), 12) +
          print_whitespace(3) +
          align_right($("#lblTotalBon").html(), 12) +
          "\n"
      );
      applet.append(
        align_left("Gantungan Sangu", 18) +
          ": " +
          align_right("-", 12) +
          print_whitespace(3) +
          align_right($("#lblPayrollAllowance").html(), 12) +
          print_whitespace(3) +
          align_right("-", 12) +
          "\n"
      );
      applet.append(
        align_left("Menabung", 18) +
          ": " +
          align_right($("#lblSavingRed2").html(), 12) +
          print_whitespace(3) +
          align_right($("#lblPayrollSaving").html(), 12) +
          print_whitespace(3) +
          align_right($("#lblTotalSaving").html(), 12) +
          "\n"
      );
      applet.append(
        align_left("TOTAL", 18) +
          print_whitespace(17) +
          align_right($("#lblPayrollExpenseTotal").html(), 12) +
          print_whitespace(15) +
          "\n\n"
      );
      applet.append(
        align_left("DITERIMA", 18) +
          print_whitespace(30) +
          "Rp. " +
          align_right($("#lblPayrollTotal").html(), 10) +
          "\n"
      );
...
function align_center(text, len) {
  ...
  return (
    print_whitespace(left_space) +
    text +
    print_whitespace(len - text.length - left_space)
  );
}
...
function monitorFinding() {
  if (applet != null) {
    if (!applet.isDoneFinding()) {
      ...
      if ($("#bkk_printmatrix").length > 0) {
        $("#bkk_printmatrix").show();
      }
      if ($("#order_printmatrix").length > 0) {
        $("#order_printmatrix").show();
      }
      if ($("#premi_printmatrix").length > 0) {
        $("#premi_printmatrix").show();
      }
      if ($("#payroll_printmatrix").length > 0) {
        $("#payroll_printmatrix").show();
      }
    }
  } else {
...
$(document).ready(function () {
  ...
  $('input[type="radio"][data-behavior="toggle-train"]').click(function (evt) {
    if ($(this).val() == "true") {
      var op = document
        .getElementById("invoice_tanktype")
...
$(document).ready(function () {
  $('input[type="radio"][data-behavior="toggle-standart"]').click(function (
    evt
  ) {
    if ($(this).val() == "false") {
      var op = document
...
function getAllowances() {
  ...
  $.ajax({
    type: "GET",
    url:
      "/invoices/getallowances/" +
      $("#invoice_route_id").attr("value") +
      "/" +
      $("#invoice_vehicle_id").attr("value") +
      "/" +
      $("#invoice_trip_type").attr("value") +
      "/" +
      $("#invoice_quantity").attr("value") +
      "/" +
      ishelper +
      "/" +
      ispremi,
    ...
    success: function (data) {
      ...
      $("#invoice_additional_gas_allowance").html(
        data.additional_gas_allowance
      );
...
function changeDriverAllowance(qty) {
  $("#invoicereturn_driver_allowance").val(
    Number($("#invoicereturn_price_per").val()) * parseInt(qty)
  );
  $("#invoicereturn_helper_allowance").val(
    Number($("#invoicereturn_helper_trip").val()) * parseInt(qty)
  );
  $("#invoicereturn_misc_allowance").val(
    Number($("#invoicereturn_misc_per").val()) * parseInt(qty)
  );
  $("#invoicereturn_gas_leftover").val(
    Number($("#invoicereturn_gas_per").val()) * parseInt(qty)
  );
  $("#invoicereturn_ferry_fee").val(
    Number($("#invoicereturn_ferry_per").val()) * parseInt(qty)
  );
  $("#invoicereturn_tol_fee").val(
    Number($("#invoicereturn_tol_per").val()) * parseInt(qty)
  );
}

function changeBonus(qty) {
  $("#bonusreceipt_total_bonus").val(
    Number($("#bonus_route").val()) * parseInt(qty)
  );
}
...
function getTaxinvoiceItems() {
  ...
  $.ajax({
    type: "GET",
    url:
      "/taxinvoices/gettaxinvoiceitems/" +
      taxinvoice_id +
      "/" +
      customer_id +
      "/" +
...
function adjustGas() {
  ...
  var gas_total =
    parseInt(gas_start) - parseInt(gas_voucher) - parseInt(gas_leftover);
  var gas_allowance_new = 0;
  if (gas_total > 0) gas_allowance_new = gas_total * Number(gas_cost);

  var total = $("#invoice_total").val();
  total =
    Number(total.split(".").join("")) -
    Number(gas_allowance.split(".").join("")) +
    Number(gas_allowance_new);
...
function changeTaxes() {
  ...
  if ($("#taxinvoice_dp_cost").length > 0) {
    var dp_cost = Number(
      $("#taxinvoice_dp_cost").val().split(".").join("").replace(",", ".")
    );
  } else {
    var dp_cost = 0;
  }

  var extra_cost = Number(
    $("#taxinvoice_extra_cost").val().split(".").join("").replace(",", ".")
  );
  var insurance_cost = Number(
    $("#taxinvoice_insurance_cost").val().split(".").join("").replace(",", ".")
  );
  var claim_cost = Number(
    $("#taxinvoice_claim_cost").val().split(".").join("").replace(",", ".")
  );
  var discount_amount = Number(
    $("#taxinvoice_discount_amount").val().split(".").join("").replace(",", ".")
  );
  ...
  $("#tbItem > tbody > tr").each(function () {
    ...
    if (parseInt(id) > 0) {
      if ($("input:radio[name='price_by']:checked").val() == "is_wholesale") {
        ...
        $("input:radio[name='price_by']:checked").val() == "is_gross"
      ) {
        var qty = $("#gross_" + id)
          .val()
          .split(".")
...
function countTotalInvoiceGeneric(taxgeneric_id) {
  ...
  if ($("input:radio[name='price_by']:checked").val() == "is_gross") {
    if ($("#_price_" + taxgeneric_id).val() >= 300000) {
      ...
      totalitem = Number(
        $("#_gross_" + taxgeneric_id).val() *
          $("#_price_" + taxgeneric_id).val()
      );
    }
  } else {
    if ($("#_price_" + taxgeneric_id).val() >= 300000) {
      ...
      totalitem = Number(
        $("#_net_" + taxgeneric_id).val() * $("#_price_" + taxgeneric_id).val()
      );
    }
  }
...
function changeTaxesGeneric() {
  ...
  var ppn = Number($("#ppn").val());
  var total = Number(
    $("#lbl_subtotal").html().split(".").join("").replace(",", ".")
  );
  var extra_cost = Number(
    $("#taxinvoice_extra_cost").val().split(".").join("").replace(",", ".")
  );
...
function minmax(value, min, max) {
  ...
  if (parseFloat($val) < 0.0 || isNaN($val)) return 0;
...
function getBranchStats() {
  ...
  $.ajax({
    type: "GET",
    url:
      "/reports/getbranchstats?type=customers&startdate=" +
      startdate +
      "&enddate=" +
      enddate,
    success: function (data) {
  ...
  $.ajax({
    type: "GET",
    url:
      "/reports/getbranchstats?type=events&startdate=" +
      startdate +
      "&enddate=" +
      enddate,
    success: function (data) {
  ...
  $.ajax({
    type: "GET",
    url:
      "/reports/getbranchstats?type=eventsomzet&startdate=" +
      startdate +
      "&enddate=" +
      enddate,
    success: function (data) {
  ...
  $.ajax({
    type: "GET",
    url:
      "/reports/getbranchstatsbkk?type=bkk&startdate=" +
      startdate +
      "&enddate=" +
      enddate,
    success: function (data) {
  ...
  $.ajax({
    type: "GET",
    url:
      "/reports/getbranchstatsbkk?type=kos&startdate=" +
      startdate +
      "&enddate=" +
      enddate,
    success: function (data) {
  ...
  $.ajax({
    type: "GET",
    url:
      "/reports/getbranchstatsbkk?type=non&startdate=" +
      startdate +
      "&enddate=" +
      enddate,
    success: function (data) {
  ...
  $.ajax({
    type: "GET",
    url:
      "/reports/getbranchstatsbkkbreakdown?type=truk&startdate=" +
      startdate +
      "&enddate=" +
      enddate,
    success: function (data) {
  ...
  $.ajax({
    type: "GET",
    url:
      "/reports/getbranchstatsbkkbreakdown?type=kereta&startdate=" +
      startdate +
      "&enddate=" +
      enddate,
    success: function (data) {
  ...
  $.ajax({
    type: "GET",
    url:
      "/reports/getbranchstatsbkkbreakdown?type=roro&startdate=" +
      startdate +
      "&enddate=" +
      enddate,
    success: function (data) {
  ...
  $.ajax({
    type: "GET",
    url:
      "/reports/getbranchstatsbkkbreakdown?type=losing&startdate=" +
      startdate +
      "&enddate=" +
      enddate,
    success: function (data) {
  ...
  $.ajax({
    type: "GET",
    url:
      "/reports/getbranchstatsincidents?startdate=" +
      startdate +
      "&enddate=" +
      enddate,
    success: function (data) {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (window.ApexCharts) {
        var options = {
          ...
          series: [
            {
              name: "Omzet",
              data: data.users.omzet_46, // Data for each month
            },
          ],
          tooltip: {
            theme: "light",
        ...
        var chart = new ApexCharts($("#chart-omzet-46")[0], options);
        chart.render();
      }
      ...
      if (window.ApexCharts) {
        var options = {
          ...
          series: [
            {
              name: "Omzet",
              data: data.users.omzet_79, // Data for each month
            },
          ],
          tooltip: {
            theme: "light",
        ...
        var chart = new ApexCharts($("#chart-omzet-79")[0], options);
        chart.render();
      }
      ...
      if (window.ApexCharts) {
        var options = {
          ...
          series: [
            {
              name: "Omzet",
              data: data.users.omzet_134, // Data for each month
            },
          ],
          tooltip: {
            theme: "light",
        ...
        var chart = new ApexCharts($("#chart-omzet-134")[0], options);
        chart.render();
      }
      ...
      if (window.ApexCharts) {
        var options = {
          ...
          series: [
            {
              name: "Omzet",
              data: data.users.omzet_138, // Data for each month
            },
          ],
          tooltip: {
            theme: "light",
        ...
        var chart = new ApexCharts($("#chart-omzet-138")[0], options);
        chart.render();
      }
      ...
      if (window.ApexCharts) {
        var options = {
          ...
          series: [
            {
              name: "Omzet",
              data: data.users.omzet_151, // Data for each month
            },
          ],
          tooltip: {
            theme: "light",
      ...
      if (window.ApexCharts) {
        ...
        var chart = new ApexCharts($("#pie-chart-2")[0], options);
        chart.render();
      }
    },
    failure: function () {
...
function getProductByGroup() {
  ...
  $.ajax({
    ...
    success: function (data) {
      for (j = 1; j <= 10; j++) {
        prod = data.products;
        $("#productrequestitems_" + j)
          .find("option")
          .remove();
        $("#productrequestitems_" + j).append(
...
function getOfficeexpensegroup() {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $("#officeexpensegroupchild").append(
...
function getTaxInvoiceCustomerbyDate() {
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (prod.length == 0) {
        $("#lblWarning").html(
          "Maaf data Surat Jalan untuk tanggal " + date + " kosong."
        );
        $("#lblWarning").show();
      } else {
...
function getDriverforPayroll() {
  ...
  if (type == "h") $(".row-helper").addClass("hide");
  else $(".row-helper").removeClass("hide");
...
function countPayrollDriverExpense() {
  ...
  if (holidays + non_holidays > 31) {
    ...
    var holidays_payment =
      holidays * Number($("#lblHolidaysFare").html().split(".").join(""));
    $("#lblHolidays").html(holidays.formatMoney(0, ",", "."));
    $("#lblHolidaysPayment").html(holidays_payment.formatMoney(0, ",", "."));

    var non_holidays_payment =
      non_holidays *
      Number($("#lblNonHolidaysFare").html().split(".").join(""));
    $("#lblNonHolidays").html(non_holidays.formatMoney(0, ",", "."));
    $("#lblNonHolidaysPayment").html(
      non_holidays_payment.formatMoney(0, ",", ".")
    );

    var saving_reduction = Number($("#payroll_saving_reduction").val());
    var saving_red =
      Number($("#lblMasterSaving").html().split(".").join("")) -
      saving_reduction;
    ...
    var totalweightloss =
      Number($("#lblMasterWeightLoss").html().split(".").join("")) - weightloss;
    ...
    var totalaccident =
      Number($("#lblMasterAccident").html().split(".").join("")) - accident;
    ...
    var totalsparepart =
      Number($("#lblMasterSparepart").html().split(".").join("")) - sparepart;
    ...
    var totalsaving =
      Number($("#lblSavingRed2").html().split(".").join("")) + saving;
    $("#lblPayrollSaving").html(saving.formatMoney(0, ",", "."));
    $("#lblTotalSaving").html(totalsaving.formatMoney(0, ",", "."));

    var expense_total =
      weightloss + accident + sparepart + bon + saving + allowance;
...
function countTotalAssetOrder() {
  var unit_price = $("#assetorder_unit_price")
    .val()
    .split(".")
    .join("")
    .replace(",", ".");
...
function countTotalClaim() {
  ...
  if (claimmemo_weight_gross != "" && shrink_tolerance_percent != "") {
    var tolerance_total =
      claimmemo_weight_gross * (shrink_tolerance_percent / 100);
  ...
  var price_per = $("#claimmemo_price_per")
    .val()
    .split(".")
    .join("")
    .replace(",", ".");
...
$(document).ready(function () {
  ...
  // clear submenus
  $("#main, #footer, #nav").click(function (e) {
    hideAllSubs();
  });
  ...
  $("#invoice_submit").live("click", function (e) {
    ...
    if (
      $("#invoice_kosongan").val() == false ||
      $("#invoice_kosongan").length == 0
    ) {
      if (
        $("#invoice_event_id").val() == 0 ||
        $("#invoice_event_id").val() == ""
      ) {
    ...
    if (tanktype_name == "ISOTANK") {
      ...
      tanktype_name == "DRY CONTAINER 20FT" ||
      tanktype_name == "DRY CONTAINER 40FT" ||
      tanktype_name == "SIDE DOOR CONTAINER 20FT" ||
      tanktype_name == "SIDE DOOR CONTAINER 40FT" ||
      tanktype_name == "KONTAINER STANDART" ||
      tanktype_name == "KONTAINER 20FT" ||
      tanktype_name == "KONTAINER 40FT" ||
      tanktype_name == "KONTAINER SIDE DOOR"
    ) {
  ...
  $("#invoicereturn_submit").live("click", function (e) {
    ...
    if (Number(driver_allowance) > Number(max_allowance)) {
      ...
      showMessageBox(
        "Sangu tidak boleh melebihi total Rp. " + max_allowance,
        2500
      );
    } else {
      form.submit();
  ...
  $("#officeexpense_submit").live("click", function (e) {
    ...
    if (
      $("#officeexpensegroupparent").val() == "1" &&
      $("#vehicle_id").val() == ""
    ) {
      errors = addComma(errors, "<strong>Kendaraan</strong>");
    }
    ...
    if (
      $("#officeexpensegroupparent").val() != "" &&
      $("#officeexpensegroupchild").val() == ""
    ) {
  ...
  $("#invoicereturnadd_submit").live("click", function (e) {
    ...
    if (samedate == true) {
      errors = addComma(
        errors,
        "<strong>Tanggal BKM Tambahan tidak boleh sama dengan tanggal BKM sebelumnya</strong>"
      );
    }
  ...
  if ($("#chart-omzet-penagihan").length > 0) {
    getOmzetPenagihan();
  }
  ...
  $(document).on("click", "#calculateDistance", function (e) {
    ...
    if (!longitudeStart || !latitudeStart || !longitudeEnd || !latitudeEnd) {
      ...
      var url =
        "/routelocations/checkDistance?latitude_start=" +
        latitudeStart +
        "&longitude_start=" +
        longitudeStart +
        "&latitude_end=" +
  ...
  if (
    ...
    $("#premi-print").length > 0 ||
    $("#payroll-print").length > 0
  ) {
    jZebra(); //init jZebra applet

    if ($("#bkk_printmatrix").length > 0) {
      $("#bkk_printmatrix").hide();
    }
    if ($("#order_printmatrix").length > 0) {
      $("#order_printmatrix").hide();
    }
    if ($("#premi_printmatrix").length > 0) {
      $("#premi_printmatrix").hide();
    }
    if ($("#payroll_printmatrix").length > 0) {
      $("#payroll_printmatrix").hide();
    }
...
$(function () {
  $(".toggle-deleted").on("change", function () {
    $(this).is(":checked") ? $("tr.deleted").show() : $("tr.deleted").hide();
  });
});
...
$(document)
  ...
  .on("click", ".btn-edit-tax", function (e) {
    ...
    $("#txt_extra_cost").text(
      $(this).data("extra-cost").formatMoney(2, ",", ".")
    );
    ...
    doubtful_ar = $(this).data("doubtful-ar");
    if (doubtful_ar == true) {
      $("#chk_doubtful_ar").attr("checked", "checked");
    }
    ...
    if (
      (parseFloat(gst_tax) > 0 && parseFloat(gst_percentage) == 0) ||
      parseFloat(gst_percentage) == ppn
    ) {
    ...
    $.ajax({
      ...
      error: function (err) {
        ...
        $.each(err.errors, function (column, message) {
          ...
          content =
            '<span class="error-message" style="color: red; margin-left: 115px; margin-top: 5px; display: block;">' +
            message[0].message +
            "</span>";

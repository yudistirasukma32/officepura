...
ActiveRecord::Schema.define(:version => 20221024091550) do
  ...
  add_index "routelocations", ["customer_id", "customer_id"], :name => "index_routelocations_on_customer_id_and_customer_id"
  add_index "routelocations", ["route_id", "route_id"], :name => "index_routelocations_on_route_id_and_route_id"
